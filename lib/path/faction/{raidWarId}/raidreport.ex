defmodule Torngen.Client.Path.Faction.RaidWarId.Raidreport do
  @moduledoc """
  ...
  @response_modules [FactionRaidWarReportResponse]
  ...
  @impl true
  defparameter :raidWarId, value do
    # Raid war id
    {:path, :raidWarId, value}
  end
