defmodule Torngen.Client.Schema.FactionRaidWarfare do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          defender: Torngen.Client.Schema.FactionRaidWarfareFaction.t(),
          aggressor: Torngen.Client.Schema.FactionRaidWarfareFaction.t()
        }
