defmodule Torngen.Client.Schema.UserEvent do
  ...
  def parse(%{} = data) do
    %__MODULE__{
      ...
      id: data |> Map.get("id") |> Torngen.Client.Schema.parse(Torngen.Client.Schema.UserEventId),
  ...
  defp validate_key?(:id, value) do
    Torngen.Client.Schema.validate?(value, Torngen.Client.Schema.UserEventId)
  end
