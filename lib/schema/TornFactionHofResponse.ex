defmodule Torngen.Client.Schema.TornFactionHofResponse do
  ...
  def parse(%{} = data) do
    %__MODULE__{
      factionhof:
        data
        |> Map.get("factionhof")
        |> Torngen.Client.Schema.parse({:array, {:ref, Torngen.Client.Schema.TornFactionHof}}),
      _metadata:
        data
        |> Map.get("_metadata")
  ...
  defp validate_key?(:factionhof, value) do
    Torngen.Client.Schema.validate?(value, {:array, {:ref, Torngen.Client.Schema.TornFactionHof}})
  end
