defmodule Torngen.Client.Schema.TornItem do
  ...
  @type t :: %__MODULE__{
          ...
          details:
            nil
            | Torngen.Client.Schema.TornItemArmorDetails.t()
            | Torngen.Client.Schema.TornItemWeaponDetails.t(),
  ...
  def parse(%{} = data) do
    %__MODULE__{
      ...
      is_tradable:
        data |> Map.get("is_tradable") |> Torngen.Client.Schema.parse({:static, :boolean}),
