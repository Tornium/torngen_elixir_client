defmodule Torngen.Client.Schema.TornEliminationTeamPlayersResponse do
  @moduledoc false
  ...
  @keys [:eliminationteam, :_metadata]
  ...
  @type t :: %__MODULE__{
          eliminationteam: [Torngen.Client.Schema.TornEliminationTeamPlayer.t()],
