defmodule Torngen.Client.Schema.FactionTerritoryWar do
  ...
  @type t :: %__MODULE__{
          winner: nil | nil | Torngen.Client.Schema.FactionId.t(),
          war_id: integer(),
          territory: String.t(),
          target: integer(),
          start: integer(),
    ...
    %__MODULE__{
      winner:
        ...
        |> Torngen.Client.Schema.parse(
          {:one_of,
           [static: :null, one_of: [static: :null, ref: Torngen.Client.Schema.FactionId]]}
        ),
      ...
      factions:
        ...
        |> Map.get("factions")
        |> Torngen.Client.Schema.parse(
          {:array, {:ref, Torngen.Client.Schema.FactionTerritoryWarParticipant}}
        ),
      end:
        data
        |> Map.get("end")
