defmodule Torngen.Client.Schema.FactionWarfareChainsResponse do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          warfarechains: [Torngen.Client.Schema.FactionChainWarfare.t()],
  ...
  defp validate_key?(:warfarechains, value) do
