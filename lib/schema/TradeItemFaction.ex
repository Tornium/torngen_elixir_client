defmodule Torngen.Client.Schema.TradeItemFaction do
  @moduledoc false
  ...
  def parse(%{} = data) do
    %__MODULE__{
      ...
      type: data |> Map.get("type") |> Torngen.Client.Schema.parse({:enum, :string, ["Faction"]}),
      details:
        data
        |> Map.get("details")
  ...
  defp validate_key?(:type, value) do
    Torngen.Client.Schema.validate?(value, {:enum, :string, ["Faction"]})
  end
