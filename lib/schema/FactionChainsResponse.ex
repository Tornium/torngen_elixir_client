defmodule Torngen.Client.Schema.FactionChainsResponse do
  ...
  def parse(%{} = data) do
    %__MODULE__{
      chains:
        data
        |> Map.get("chains")
        |> Torngen.Client.Schema.parse({:array, {:ref, Torngen.Client.Schema.FactionChain}}),
      _metadata:
        data
        |> Map.get("_metadata")
  ...
  defp validate_key?(:chains, value) do
    Torngen.Client.Schema.validate?(value, {:array, {:ref, Torngen.Client.Schema.FactionChain}})
  end
